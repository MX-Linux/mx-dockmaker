...
4. Press &quot;Add application&quot; to continue or &quot;Save&quot; to finish</source>
        <translation>1. アプリケーションを1つずつドックに追加します
2. .desktop ファイルを選択するか、必要なアプリケーションのコマンドを入力します。
3. アイコンのサイズ、背景（黒が標準）、枠線の属性を選択します。
...
3. When finished click Save</source>
        <translation>1. 「戻る」ボタンと「次へ」ボタンを使って、アプリケーションを1つずつ編集します。
2. 好きなようにアプリケーションを追加したり削除します
